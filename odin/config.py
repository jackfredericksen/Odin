...
from .core.config_manager import OdinConfig, get_config, get_config_manager
...
class LegacyConfig:
    ...
    # Trading settings
    ENABLE_LIVE_TRADING = property(
        lambda self: self._config.trading.enable_live_trading
    )
...
def migrate_legacy_config():
    ...
    """
    legacy_config_files = [".env", "config.ini", "settings.json"]
    ...
    return {
        ...
        "exchange": {
            ...
            "has_credentials": bool(
                config.exchange.api_key and config.exchange.secret_key
            ),
        },
        "data": {
