    ...
    def get_regime_transition_matrix(self, days: int = 90) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_transitions": sum(sum(to_regimes.values()) for to_regimes in transitions.values()),
    ...
    def get_confidence_analytics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if len(recent_confidences) >= 3:
                ...
                elif all(recent_confidences[i] > recent_confidences[i+1] for i in range(len(recent_confidences)-1)):
                    confidence_trend = "decreasing"
            
            return {
                "regime_confidence": confidence_stats,
                "overall_trend": confidence_trend,
                "recent_avg": round(np.mean(recent_confidences), 3) if recent_confidences else 0,
