...
class OdinLogger:
    ...
    def error(self, message: str, context: Optional[Union[LogContext, Dict[str, Any]]] = None, **kwargs):
        """Log error message."""
        self._log(LogLevel.ERROR, message, context, **kwargs)
    
    def critical(self, message: str, context: Optional[Union[LogContext, Dict[str, Any]]] = None, **kwargs):
        """Log critical message."""
        self._log(LogLevel.CRITICAL, message, context, **kwargs)
    
    def exception(self, message: str, context: Optional[Union[LogContext, Dict[str, Any]]] = None, **kwargs):
        """Log exception with traceback."""
        kwargs['exc_info'] = True
        self._log(LogLevel.ERROR, message, context, **kwargs)
    
    def _log(self, level: LogLevel, message: str, context: Optional[Union[LogContext, Dict[str, Any]]], **kwargs):
...
def log_operation_success(logger: OdinLogger, operation: str, duration: float = None, **context_data):
...
def log_operation_error(logger: OdinLogger, operation: str, error: Exception, **context_data):
    """Log operation error."""
    additional_data = context_data.copy()
...
def demo_logging():
    ...
    trading_logger = logger.with_context(LogContext(
        component="trading_engine",
    ...
    log_operation_success(logger, "data_collection", duration=1.5, records_collected=100)
