...
async def check_data_collection_health(
    ...
    try:
        ...
        healthy_sources = sum(1 for source in sources_status if source.get("healthy", False))
...
async def check_external_apis_health(
    ...
    try:
        ...
        healthy_times = [
            api["response_time_ms"] for api in api_health.values() 
        ...
        return {
            ...
            "apis": api_health,
            "healthy_count": sum(1 for api in api_health.values() if api.get("healthy")),
