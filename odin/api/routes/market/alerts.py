...
async def get_market_alerts(
    ...
    try:
        ...
        urgent_alerts = [
            ...
            if a.get("severity") in ["critical", "high"] and a.get("requires_action", False)
        ]
...
async def configure_alerts(
    ...
    try:
        ...
        valid_alert_types = [
            "price_threshold", "price_change", "volume_spike", 
            "volatility_spike", "support_resistance", "technical_indicator"
        ]
        ...
        alert_configuration = {
            ...
            "notification_methods": alert_config.get("notification_methods", ["in_app"]),
...
async def get_alert_history(
    ...
    try:
        ...
        for alert in alert_history:
            ...
            history_stats["by_type"][alert_type] = history_stats["by_type"].get(alert_type, 0) + 1
...
async def get_alert_configurations(
    ...
    try:
        ...
        for config in user_configs:
            ...
            config_stats["by_type"][alert_type] = config_stats["by_type"].get(alert_type, 0) + 1
            
            # Count by severity
            severity = config["severity"]
            config_stats["by_severity"][severity] = config_stats["by_severity"].get(severity, 0) + 1
...
async def generate_market_alerts(current_data, recent_data) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        if hasattr(current_data, 'change_24h') and current_data.change_24h:
            if abs(current_data.change_24h) > 0.10:  # 10% change
                alerts.append({
                    ...
                    "type": "price_change",
                    "severity": "high" if abs(current_data.change_24h) > 0.15 else "medium",
        ...
        # Volume alerts
        if hasattr(current_data, 'volume_24h') and current_data.volume_24h and len(recent_data) > 10:
