...
class MovingAverageStrategy(Strategy):
    ...
    def __init__(self, short_window: int = 5, long_window: int = 20, **kwargs):
        ...
        self.logger.info(
            f"Initialized MA strategy: short={short_window}, long={long_window}"
        )
    ...
    def generate_signal(self, data: pd.DataFrame) -> Signal:
        ...
        # Death Cross (sell signal)
            ...
            ma_short_previous >= ma_long_previous and ma_short_current < ma_long_current
        ):
    ...
    def _calculate_confidence(self, row: pd.Series, signal_type: SignalType) -> float:
        ...
        volatility_confidence = max(
            0, 1.0 - volatility_norm * 50
    ...
    def get_parameter_ranges(self) -> Dict[str, Tuple[float, float]]:
        ...
        """
        return {"short_window": (3, 15), "long_window": (10, 50)}
    ...
    def update_parameters(self, parameters: Dict[str, Any]) -> None:
        ...
        self.logger.info(
            f"Updated parameters: short={self.short_window}, long={self.long_window}"
        )
    ...
    def __str__(self) -> str:
        return (
            f"MovingAverageStrategy(short={self.short_window}, long={self.long_window})"
        )
